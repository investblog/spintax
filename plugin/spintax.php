...
spl_autoload_register(
	// phpcs:ignore Universal.NamingConventions.NoReservedKeywordParameterNames.classFound -- standard PSR-4 autoloader convention.
	function ( $class ) {
		$prefix = 'Spintax\\';
		$len    = strlen( $prefix );
